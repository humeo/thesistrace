...
export const quickCommands = [
  ...
  ['uv', ['run', '--project', 'apps/core', 'pytest', '-c', 'apps/core/pyproject.toml', '--rootdir', '.', '-q', '-n', '4', '-m', 'not bounded_process', ...['kernel', 'architecture', 'adapters', 'data', 'entrypoints'].map(name => 'apps/core/tests/' + name), 'tooling/test/tests']],
  ['uv', ['run', '--project', 'apps/core', 'pytest', '-c', 'apps/core/pyproject.toml', '--rootdir', '.', '-q', '-m', 'bounded_process', 'apps/core/tests/kernel', 'apps/core/tests/entrypoints']],
