...
roughly 16,623 baseline source requests at the current 5,541 instrument scope in
exchange for detecting every source-visible historical change with one
