...
removes unreferenced staging objects, and never publishes a partial Alpha
Matrix, Result Bundle, or Tracking Checkpoint. A User may create a new
ResearchRun only after changing the workload or after platform capacity or
