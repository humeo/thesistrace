...
and makes equivalence between batch results and session-by-session incremental
replay the end-to-end V1 correctness goal. AI Chat, MCP, multi-tenancy,
notifications, and automated trading remain outside this first product loop.
