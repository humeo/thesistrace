...
# Expose the initial financial product only through Alpha authoring and Data readiness
...
fields and source evidence remain retained behind the Data-owned boundary for
audit and future products, but they do not expand the first executable product
slice. This keeps initial UI work on discovering, composing, running, and daily
tracking the six stable fields instead of coupling core financial research to a
