...
## Researcher access operations

There is no public signup or Web Admin. Run Auth Operator commands inside the
private Production topology after `production-runtime up`. This helper function
keeps the canonical project, external environment, and overlays together:
