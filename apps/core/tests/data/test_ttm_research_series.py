...
def test_ttm_windows_survive_data_slices_and_control_alpha_missing_coverage() -> None:
    ...
    row_data = AlignedResearchData(
        ...
        universe_members=members, historical_universe_members=members, industries={},
        execution_prices={}, trading_states={},
    ...
    columnar = ColumnarResearchData(
        ...
        _industries=pa.table({
            ...
            for key in ("instrument_id", "active_from", "active_to", "sw2021_l1")
        }),
