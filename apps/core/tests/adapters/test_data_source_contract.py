...
def test_live_tushare_gate_is_separate_from_the_default_gate(
    ...
    assert "apps/core/tools/check_live_tushare.py" not in default_gate
    assert "uv run --project apps/core python apps/core/tools/check_live_tushare.py" in live_gate
