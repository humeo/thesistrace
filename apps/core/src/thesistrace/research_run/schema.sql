...
CREATE TABLE research_runs.execution_checkpoints (
    ...
    CONSTRAINT execution_checkpoints_factor_observation_check CHECK (factor_observation_payload IS NULL OR jsonb_typeof(factor_observation_payload) = 'object'),
    ...
    CONSTRAINT execution_checkpoints_strategy_events_check CHECK (jsonb_typeof(strategy_event_payloads) = 'object'),
