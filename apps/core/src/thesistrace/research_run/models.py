...
class StrategyProgramDetails(BaseModel):
    model_config = ConfigDict(extra="forbid", frozen=True)
    kind: Literal["strategy_program"] = "strategy_program"
    error_type: str
    line: int | None = None
...
class ResearchRunAdmissionIssue(BaseModel):
    ...
    details: (
        DiagnosticDetails | ResearchAdmissionDetails | RerunSourceDetails
        | StrategyProgramDetails | None
    ) = None
