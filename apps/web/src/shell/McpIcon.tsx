...
// Official mark: https://github.com/modelcontextprotocol/modelcontextprotocol/blob/main/docs/favicon.svg
// Retain the mark paths; omit the favicon background and inherit navigation color.
export function McpIcon({ size = 18 }: IconProps) {
  return <svg aria-hidden="true" width={size} height={size} viewBox="0 0 180 180" fill="none" stroke="currentColor" strokeWidth="11.0667" strokeLinecap="round">
