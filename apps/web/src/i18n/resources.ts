...
export const resources = {
  en: { operator: { researchers: operatorResearchersEn, data: operatorDataEn }, mcp: mcpEn, chat: chatEn, daily: dailyEn, runs: runsEn, batches: batchesEn, analysis: { ...analysisEn, metrics: metricHelpEn }, common: commonEn, navigation: navigationEn, auth: authEn, landing: { page: copy.en }, data: dataEn, editor: editorEn, diagnostics: diagnosticsEn, research: researchEn, catalog: { fields: fields.en, ...catalog.en } },
  "zh-CN": { operator: { researchers: operatorResearchersZh, data: operatorDataZh }, mcp: mcpZh, chat: chatZh, daily: dailyZh, runs: runsZh, batches: batchesZh, analysis: { ...analysisZh, metrics: metricHelpZh }, common: commonZh, navigation: navigationZh, auth: authZh, landing: { page: copy.zh }, data: dataZh, editor: editorZh, diagnostics: diagnosticsZh, research: researchZh, catalog: { fields: fields["zh-CN"], ...catalog["zh-CN"] } },
} as const;
