...
const response = {
  head: {
    ...
    financial_indicator_pending_instrument_count: 0,
    financial_indicator_checked_through_session: "2026-08-31",
    financial_indicator_complete_through_session: "2026-08-31",
  ...
  it("accepts explicitly unavailable coverage without manufacturing dates or counts", () => {
    const decoded = decodeDatasetOperationalStatus({
      ...
      head: {
        ...
        financial_indicator_pending_instrument_count: null,
        financial_indicator_checked_through_session: null,
        financial_indicator_complete_through_session: null,
