...
describe("browser auth routing", () => {
  ...
  test.each([
    ...
    "/research-runs/batches/batch_feedface",
  ...
  test.each([
    ...
    ["/research-runs/batches", "/research-runs/batches"],
    ["/research-runs/batches/batch_feedface", "/research-runs/batches/batch_feedface"],
