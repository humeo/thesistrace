...
import type { ToolFailureCode } from "@thesistrace/contracts/agent-failure";
import { isResearchA2UIMessageId, projectResearchA2UIContent, RESEARCH_A2UI_ACTIVITY_TYPE } from "@thesistrace/contracts/research-a2ui";
