...
const definitions = {
  ...
  RECOVERY_FAILED: ["Answer recovery failed", "The Agent could not generate a complete replacement answer after its one recovery attempt. Partial content and completed research are retained; do not resubmit successful operations.", "revise"],
