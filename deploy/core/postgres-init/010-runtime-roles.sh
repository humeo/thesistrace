...
: "${THESISTRACE_AGENT_DATABASE_PASSWORD:?THESISTRACE_AGENT_DATABASE_PASSWORD is required}"
...
\getenv agent_password THESISTRACE_AGENT_DATABASE_PASSWORD
...
GRANT CONNECT ON DATABASE :"database_name" TO core_runtime, auth_runtime, agent_runtime;
