...
Price, Adjustment Factor, causal cumulative-adjusted price, price-limit, and Trading
...
- [x] Adjustment Factors, same-session causal scales, and adjusted OHLC are deterministic and Generation-owned.
...
- Published source-unit EOD facts, canonical decimal strings, causal
  cumulative-adjusted OHLC, Trading State, and session price limits.
